...
```
36, 27, 11, 31, 41, 44, 48, 30, 42, 43, 46, 28, 26, 47, 45, 29, 49
```
...
```sql
sqlite> SELECT COUNT(*) FROM healthcare WHERE age>18;
```
...
```sql
sqlite> SELECT DISTINCT age FROM healthcare;
```
