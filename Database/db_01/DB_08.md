...
```python
봉 = Director.objects.get(name='봉준호')
print(f'id : {봉.id}')
print(f'name : {봉.name}')
print(f'debut : {봉.debut}')
print(f'country : {봉.country}')
```
...
```python
movies = Movie.objects.all().order_by('-opening_date')
director = Director.objects.all()
genre = Genre.objects.all()
for movie in movies:
    print(movie.director.name, movie.genre.title, movie.title, movie.opening_date, movie.running_time, movie.screening)
...
```python
봉 = Director.objects.get(name='봉준호')
movies = Movie.objects.filter(director=봉).order_by('opening_date')
director = Director.objects.all()
genre = Genre.objects.all()
for movie in movies:
    print(movie.director.name, movie.genre.title, movie.title, movie.opening_date, movie.running_time, movie.screening)
...
movies = Movie.objects.filter(director=봉, genre=drama).order_by('opening_date')
director = Director.objects.all()
genre = Genre.objects.all()
for movie in movies:
    print(movie.director.name, movie.genre.title, movie.title, movie.opening_date, movie.running_time, movie.screening)
...
```python
봉 = Director.objects.get(name='봉준호')
movies = Movie.objects.exclude(director=봉).order_by('opening_date')
director = Director.objects.all()
genre = Genre.objects.all()
for movie in movies:
    print(movie.director.name, movie.genre.title, movie.title, movie.opening_date, movie.running_time, movie.screening)
